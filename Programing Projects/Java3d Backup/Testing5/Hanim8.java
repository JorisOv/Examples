...
public class Hanim8 extends JFrame {
   ...
   public BranchGroup createSceneGraph(String filename) {
	...
	( (RotPosPathInterpolator) polTable.get(HumanoidRoot.getName()) ).setTarget(HumanoidRoot.getScaleRotateTransformGroup());
	HumanoidRoot.addChild( (RotPosPathInterpolator) polTable.get(HumanoidRoot.getName()) );
