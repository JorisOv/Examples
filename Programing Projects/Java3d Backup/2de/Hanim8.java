...
public class Hanim8 extends JFrame {
   ...
   public BranchGroup createSceneGraph() {
	...
	skullbase.addChild(cervical);

	vt1.addChild(l_shoulder);

	vt1.addChild(r_shoulder);
        r_shoulder.addChild(leftObject);
        r_shoulder.addChild(rightObject);


	vt1.addChild(skullbase);

	HumanoidRoot.addChild(l_hip);
	HumanoidRoot.addChild(r_hip);	

	
	vt1.addChild(thorasic);
	HumanoidRoot.addChild(vt1);
