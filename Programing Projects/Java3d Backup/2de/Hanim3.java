...
public class Hanim3 extends JFrame {
   ...
   public BranchGroup createSceneGraph() {
	...
	TransformGroup thorasic2 = createLimb(0.1f, 0.25f, 0.6f, Math.PI * 1.0f);
	...
	TransformGroup l_upperarm2 = createLimb(0.07f, 0.07f, 0.33f, Math.PI * 0.2f);
	l_upperarm.addChild(l_upperarm2);
	thorasic2.addChild(l_upperarm);
	
	TransformGroup l_forearm = new TransformGroup(); 
	TransformGroup l_forearm2 = createLimb(0.073f, 0.06f, 0.33f, Math.PI * -0.2f);
	...
	TransformGroup r_upperarm2 = createLimb(0.07f, 0.07f, 0.33f, Math.PI * -0.8f);
	r_upperarm.addChild(r_upperarm2);
	thorasic2.addChild(r_upperarm);
	
	TransformGroup r_forearm = new TransformGroup();
	TransformGroup r_forearm2 = createLimb(0.073f, 0.06f, 0.33f, Math.PI * -0.2f);
	...
	TransformGroup l_thigh2 = createLimb(0.1f, 0.1f, 0.45f, Math.PI * 0.0f);
	l_thigh.addChild(l_thigh2);
	HumanoidRoot.addChild(l_thigh);
	
	TransformGroup l_calf = new TransformGroup(); 
	TransformGroup l_calf2 = createLimb(0.11f, 0.06f, 0.45f, Math.PI * 0.0f);
	l_calf.addChild(l_calf2);
	l_thigh2.addChild(l_calf);
	
	TransformGroup l_foot = new TransformGroup();
	TransformGroup l_foot2 = createLimb(0.08f, 0.01f, 0.0f, Math.PI * 0.0f);
	...
	vt1.set(new Vector3f(0.0f, 0.5f, 0.0f) );
	...
	l_elbow.set(new Vector3f(0.0f, 0.33f, 0.0f));
	l_forearm.setTransform(l_elbow);

	Transform3D l_wrist = new Transform3D();
	l_wrist.set(new Vector3f(0.0f, 0.33f, 0.0f));
	...
	r_elbow.set(new Vector3f(0.0f, 0.33f, 0.0f) );
	r_forearm.setTransform(r_elbow);

	Transform3D r_wrist = new Transform3D();
	r_wrist.set(new Vector3f(0.0f, 0.33f, 0.0f));
