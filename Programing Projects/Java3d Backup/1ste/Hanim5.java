...
public class Hanim5 extends JFrame {
   ...
   public BranchGroup createSceneGraph() {
	...
	TransformGroup thorasic2 = createLimb(0.1f, 0.25f, TRUNK_LENGTH, new Vector3f(0.0f, TRUNK_LENGTH, 0.0f) );
	...
	TransformGroup cervical2 = createLimb(0.15f, 0.07f, 0.4f, new Vector3f(0.0f, -0.23f, 0.0f) );
	...
	TransformGroup l_upperarm2 = createLimb(0.07f, 0.07f, UPPER_ARM_LENGTH, new Vector3f(-0.28f, 0.05f, 0.0f) );
	...
	TransformGroup l_forearm2 = createLimb(0.073f, 0.06f, FORE_ARM_LENGTH, new Vector3f(0.0f, UPPER_ARM_LENGTH, 0.0f));
	...
	TransformGroup l_hand2 = createLimb(0.08f, 0.01f, 0.0f, new Vector3f(0.0f, FORE_ARM_LENGTH, 0.0f));
	...
	TransformGroup r_upperarm2 = createLimb(0.07f, 0.07f, UPPER_ARM_LENGTH, new Vector3f(0.28f, 0.05f, 0.0f) );
	...
	TransformGroup r_forearm2 = createLimb(0.073f, 0.06f, FORE_ARM_LENGTH, new Vector3f(0.0f, UPPER_ARM_LENGTH, 0.0f) );
	...
	TransformGroup r_hand2 = createLimb(0.08f, 0.01f, 0.0f, new Vector3f(0.0f, FORE_ARM_LENGTH, 0.0f));
	...
	TransformGroup l_thigh2 = createLimb(0.08f, 0.08f, THIGH_LENGTH, new Vector3f(0.16f, -0.03f, 0.0f) );
	...
	TransformGroup l_calf2 = createLimb(0.09f, 0.07f, CALF_LENGTH, new Vector3f(0.0f, THIGH_LENGTH, 0.0f));
	...
	TransformGroup l_foot2 = createLimb(0.08f, 0.07f, FOOT_LENGTH, new Vector3f(0.0f, CALF_LENGTH, 0.0f));
	...
	TransformGroup r_thigh2 = createLimb(0.08f, 0.08f, THIGH_LENGTH, new Vector3f(-0.16f, -0.03f, 0.0f) );
	...
	TransformGroup r_calf2 = createLimb(0.09f, 0.07f, CALF_LENGTH, new Vector3f(0.0f, THIGH_LENGTH, 0.0f));
	...
	TransformGroup r_foot2 = createLimb(0.08f, 0.07f, FOOT_LENGTH, new Vector3f(0.0f, CALF_LENGTH, 0.0f));
	...
	//vt1.rotZ( Math.PI *  1.0f);
	vt1.rotZ( Math.PI *  0.5f);
  ...
  public TransformGroup createLimb(float radius, float radius2, float heigth, Vector3f trans) {
	...
	if (radius > 0.0f) {
 	...
 	Transform3D translate = new Transform3D();
  	translate.set(trans);
	base.setTransform(translate);
   	
  	return base;	
  }
  
   public static void main(String[] args) {
      JFrame frame = new Hanim5();
   } 
